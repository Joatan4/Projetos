...
let compras = ["refrigerante","água","pão"];
...
console.log(`o tamanho é igual a: ${compras.length}`);
...
// Escreva seu código abaixo:
let playlist = ["Yesterday", "Bohemian Rhapsody", "Halo"];

//undefined

console.log (playlist.splice(2,2, "starboy"));
...
// Escreva seu código abaixo:
let notas = ["8.5","6.0","7.5", "9.0"]
let soma = [0];
for (let nota of soma) {
